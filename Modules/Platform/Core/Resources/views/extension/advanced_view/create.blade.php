<form method="POST" action="{{ route('core.advanced-view.create') }}" accept-charset="UTF-8" class="module_form" id="advanced_view_settings_form" >
            ...
            <div>
                ...
                <div>
                    <select name="visibility" class="form-control select_material" id="visibility">
                        <option value="public">@lang('core::core.advanced_view.public')</option>
                        <option value="private">@lang('core::core.advanced_view.private')</option>
                    </select>
                </div>
