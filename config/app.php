...
return [
    ...
    */
    ...
    'salt_api' => env('CRYPTOR_SALT_API'),
    'key_api' => env('CRYPTOR_KEY_API'),

    'salt_api_admin' => env('CRYPTOR_SALT_ADMIN'),
    'key_api_admin' => env('CRYPTOR_KEY_ADMIN'),
    'key_api_admin_member' => env('CRYPTOR_KEY_ADMIN_MEMBER'),
