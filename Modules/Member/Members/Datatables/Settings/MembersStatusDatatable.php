...
namespace Modules\Member\Members\Datatables\Settings;
 ...
 */
class MembersStatusDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'member.members.status.show';

    protected $editRoute = 'member.members.status.edit';
     ...
     */
    public function query(MembersStatus $model)
    {
