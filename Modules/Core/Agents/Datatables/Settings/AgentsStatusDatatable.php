...
namespace Modules\Core\Agents\Datatables\Settings;
 ...
 */
class AgentsStatusDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'core.agents.status.show';

    protected $editRoute = 'core.agents.status.edit';
     ...
     */
    public function query(AgentsStatus $model)
    {
