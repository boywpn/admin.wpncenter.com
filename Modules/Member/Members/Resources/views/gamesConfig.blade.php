...
<form class="form-horizontal" method="post" action="{{ route('member.members.games_config.save', $entity->id) }}">
    @csrf
            ...
            <div class="panel panel-col-cyan">
                ...
                <div id="game_{{ $game['id'] }}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="gameHead_{{ $game['id'] }}">
                    <div class="panel-body">
                        ...
                        <h4>{{ trans('member/members::members.game_config.commissions') }}</h4>
