...
class Builder
{
    ...
    public function parameters(array $attributes = [])
    {
        ...
        $attributes['lengthMenu'] = (isset($attributes['lengthMenu'])) ? $attributes['lengthMenu'] : [ [10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"] ];
        $attributes['pageLength'] = (isset($attributes['pageLength'])) ? $attributes['pageLength'] : 50;
