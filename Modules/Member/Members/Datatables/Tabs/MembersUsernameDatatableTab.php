 ...
 */
class MembersUsernameDatatableTab extends RelationDataTable
{
    const SHOW_URL_ROUTE = 'core.username.show';

    protected $unlinkRoute = 'member.members.username.unlink';
    ...
    public function dataTable($query)
    {
        ...
        $this->applyLinks($dataTable, self::SHOW_URL_ROUTE, 'username_');
    ...
    {
        return $this->builder()
            ->setTableId('MembersUsernameDatatable' . $this->tableSuffix)
    ...
    protected function getColumns()
    {
        ...
        $columns = MembersUsernameDatatableTab::availableColumns();
