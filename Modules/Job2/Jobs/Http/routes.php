...
Route::group(['middleware' => ['web','permission:job2.jobs.browse'], 'prefix'=>'job2', 'as'=>'job2.', 'namespace' => 'Modules\Job2\Jobs\Http\Controllers'], function () {
...
//    });
    ...
    Route::get('jobs/', ['as'=>'jobs.search.members', 'uses' => 'JobsController@test']);
